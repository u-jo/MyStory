...
describe "Authentication" do
	...
	describe "authorization" do
		describe "for non-signed-in users" do
			...
			describe "in the scribbles controller" do

        		describe "submitting to the create action" do
          			before { post scribbles_path }
          			specify { expect(response).to redirect_to(signin_path) }
       			end

        		describe "submitting to the destroy action" do
          			before { delete scribble_path(FactoryGirl.create(:scribble)) }
         			specify { expect(response).to redirect_to(signin_path) }
        		end
      		end
		end
		...
		describe "as wrong user"do
			...
			describe "submitting a GET request to Users#edit action"do
				...
				specify { expect(response).not_to match(full_title('Edit user')) }
